...
public class Chat {
  ...
  /**
   * This method sets the typing status.
   * 
   * @param typing the typing status of a boolean.
   */
  ...
  /**
   * This method gets the typing status.
   * 
   * @return typing the typing status of a boolean.
   */
